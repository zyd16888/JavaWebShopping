...
<body>
	<div class="container-fluid">
			...
			<div class="col-md-10">
				...
				<c:forEach items="${list}" var="product">
					<div class="col-md-2"
						...
						<p>
							<a href="product_info.html" style='color: #666'>${product.pname}</a>
						</p>
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${product.shopPrice}</font>
						</p>
					</div>
				</c:forEach>
		...
		<div style="text-align: center; margin-top: 5px; margin-bottom: 20px;">
			Copyright &copy; 2016-2017 翡翠教育 版权所有</div>
	</div>
	</div>
</body>
