	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<c:forEach items="${productList }" var="p">
				<div class="col-md-2">
					<a href="product?method=findProductByPid&pid=${p.pid }">
						<img src="${p.pimage }" width="170" height="170" style="display: inline-block;">
					</a>
					<p style="overflow: hidden;text-overflow:ellipsis;white-space: nowrap;"><a href="product?method=findProductByPid&pid=${p.pid }" style='color:green'>${p.pname }</a></p>
