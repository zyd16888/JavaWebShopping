		...
		<div class="container">
				<div class="row">
					...
					<div style="margin:0 auto;width:950px;">
						<div class="col-md-6">
							<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${productPid.pimage }">
						</div>
	
						<div class="col-md-6">
							<div><strong>${productPid.pname }</strong></div>
							<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
								<div>编号：${productPid.pid }</div>
							</div>
	
							<div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">${productPid.shopPrice }</strong> 参 考 价： <del>${productPid.marketPrice }</del>
							</div>
